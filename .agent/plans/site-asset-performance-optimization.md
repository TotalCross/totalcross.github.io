...
- [ ] M1 — Route static raster content through Astro image optimization.
- [ ] M2 — Replace oversized animated GIF delivery with efficient web video.
- [ ] M3 — Enforce asset budgets and add the asset-optimization skill.
